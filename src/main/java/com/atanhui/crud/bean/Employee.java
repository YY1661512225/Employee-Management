...
public class Employee {
     ...
     * @mbg.generated
     */
    @Pattern(regexp = "(^[a-zA-Z0-9_-]{6,16}$)|(^[\u2E80-\u9FFF]{3,5}$)",
            message = "用户名可以是3-5位中文或者6-16位英文和数字的组合！")
    ...
    public Employee(Integer empId, String empName, String password, String gender, String email, Integer dId, Department department) {
        this.empId = empId;
